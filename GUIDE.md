...
2. [Инструкция по Установке и Настройке (Config Flow Wizard)](#2-инструкция-по-установке-и-настройке-config-flow)
3. [Подробный Разбор Элементов Карточки (Dashboard Card)](#3-подробный-разбор-элементов-карточки-dashboard-card)
4. [Сводная Таблица всех Сущностей и Органов Управления](#4-сводная-таблица-всех-сущностей-и-органов-управления)
5. [Официальные Действия Интеграции (Services)](#5-официальные-действия-интеграции-services)
6. [Тестирование и Соответствие Стандартам Home Assistant (Quality Scale)](#6-тестирование-и-соответствие-стандартам-home-assistant-quality-scale)
7. [Частые Вопросы и Диагностика (FAQ)](#7-частые-вопросы-и-диагностика-faq)
