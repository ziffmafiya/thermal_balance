...
* **Солнечная радиация ($P_{\text{solar}}$) и Умное Зашторивание**:
  $$P_{\text{solar}} = A_{\text{window}} \cdot I_{\text{solar}} \cdot g_{\text{solar\_factor}}$$
  * При открытых шторах (или без датчика Lux): $g_{\text{solar\_factor}} = 0.70$ (70% тепла проходит внутрь).
  * При зашторенных окнах (Lux $< 150\text{ lx}$ в дневное время): $g_{\text{solar\_factor}} = 0.20$ (нагрев от солнца **автоматически урезается на 70%**!).
